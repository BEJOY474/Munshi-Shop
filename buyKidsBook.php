...
<audio controls autoplay>
  <source src="music/bkFrKds.mp3" type="audio/mp3">
</audio>
...
<div style="background-color:rgb(236, 226, 226);" id="content" class="content">
    <div class="container">
        ...
        <div class="col-md-9">
            <div class="box">
                <h1>Kids-Book</h1>
                <h4>Here you can order kids-book</h4>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-6 single">
                        <div class="product headphnSlid">
                            ...
                            <div class="text t_x">
                                <h3>
                                <a href="abcOrdr.php">A B C </a>
                                </h3>
                                <p class="price">$5</p>
                                <p class="button">
                                    <a href="abcOrdr.php" class="btn btn-default">View Details</a>
                ...
                <div class="col-sm-4 col-sm-6 single">
                    <div class="product headphnSlid">
                        <a href="oneTwoOrdr.php">
                            <img style="width: 350px; height: 265px" class="img-responsive" src="kidsPic/oneTwo2.png" alt="macbookLaptop">
                        </a>

                        <div class="text t_x">
                            <h3>
                            <a href="oneTwoOrdr.php">1 2 3</a>
                            </h3>
                            <p class="price">$6</p>
                            <p class="button">
                                <a href="oneTwoOrdr.php" class="btn btn-default">View Details</a>
                ...
                <div class="col-sm-4 col-sm-6 single">
                    <div class="product headphnSlid">
                        <a href="BirdsOrde.php">
                            <img style="width: 350px; height: 265px" class="img-responsive" src="kidsPic/birds2.jpeg" alt="macbookLaptop">
                        </a>

                        <div class="text t_x">
                            <h3>
                            <a href="BirdsOrde.php">Birds</a>
                            </h3>
                            <p class="price">$7</p>
                            <p class="button">
                                <a href="BirdsOrde.php" class="btn btn-default">View Details</a>
                ...
                <div class="col-sm-4 col-sm-6 single">
                    <div class="product headphnSlid">
                        <a href="AnimalsOrdr.php">
                            <img style="width: 350px; height: 265px" class="img-responsive" src="kidsPic/animal.jpeg" alt="macbookLaptop">
                        </a>

                        <div class="text t_x">
                            <h3>
                            <a href="AnimalsOrdr.php">Animals</a>
                            </h3>
                            <p class="price">$10</p>
                            <p class="button">
                                <a href="AnimalsOrdr.php" class="btn btn-default">View Details</a>
                ...
                <div class="col-sm-4 col-sm-6 single">
                    <div class="product headphnSlid">
                        <a href="FruitsOrdr.php">
                            <img style="width: 350px; height: 265px" class="img-responsive" src="kidsPic/fruits.jpeg" alt="macbookLaptop">
                        </a>

                        <div class="text t_x">
                            <h3>
                            <a href="FruitsOrdr.php">Fruits</a>
                            </h3>
                            <p class="price">$5</p>
                            <p class="button">
                                <a href="FruitsOrdr.php" class="btn btn-default">View Details</a>
                ...
                <div class="col-sm-4 col-sm-6 single">
                    <div class="product headphnSlid">
                        <a href="RhymesOrdr.php">
                            <img style="width: 350px; height: 265px" class="img-responsive" src="kidsPic/rhy.jpeg" alt="macbookLaptop">
                        </a>

                        <div class="text t_x">
                            <h3>
                            <a href="RhymesOrdr.php">Rhymes</a>
                            </h3>
                            <p class="price">$8</p>
                            <p class="button">
                                <a href="RhymesOrdr.php" class="btn btn-default">View Details</a>
                ...
                <center>
                    <ul class="pagination">
                        ...
                        <li><a href="allKidsBook.php">1</a></li>
                        <li><a href="buyKidsBook.php">2</a></li>
                        <li><a href="kidsGame.php">3</a></li>
