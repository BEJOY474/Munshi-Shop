                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="images/asus.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Asus Y-20</h3>
                                            <p>Color     : White</p>
                                            <p>Price    : $1250 <br>
                                               Ram       : 8 GB  <br>
                                               Processor     : Core i7 <br>
                                            Version     : 10 Gen. <br>
                                            Product Code    : asusy20223 <br>
                                            Discount    : 5%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="detailsAsus.php" method="post">
