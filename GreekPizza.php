                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="pizzaPic/GreekPizza.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Greek Pizza</h3> 
                                            <p>Price    : $15 <br>
                                            Product Code    : gp409 <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="GreekPizza.php" method="post">
