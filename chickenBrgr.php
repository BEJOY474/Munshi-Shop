                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="food/pic-3.jpg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Chicken Burger</h3> 
                                            <p>Price    : $10 <br>
                                            Product Code    : cknb001 <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="chickenBrgr.php" method="post">
