...
<?php 
 ...
 if ( isset($_POST['submit'])) {
    ...
    if (!empty($ProductName)  && !empty($ProductCategory) && !empty($ProductCode) && !empty($ProductPrice) && !empty($Email)  && !empty($MobileNumber) && !empty($userAddress) && !empty($entryDate)) {
        ...
        $sql = "INSERT INTO laptop (ProductName,	ProductCategory,	ProductCode,	ProductPrice,	Email,	MobileNumber, userAddress,	entryDate)
                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="images/hp.webp" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : HP</h3>
                                            <p>Color     : White</p>
                                            <p>Price    : $1350 <br>
                                               Ram       : 8 GB  <br>
                                               Processor     : Core i9 <br>
                                            Version     : 11 Gen. <br>
                                            Product Code    : hp1145 <br>
                                            Discount    : 5%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="detailsHp.php" method="post">
