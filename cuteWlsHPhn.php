...
<?php 
 ...
 if ( isset($_POST['submit'])) {
        ...
        if (empty($ProductName)) {
            $empmsgProductName = 'Fill up this field';
        ...
        if (empty($ProductCategory)) {
            $empmsgProductCategory= 'Fill up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($ProductCode)) {
            $empmsgProductCode = 'Fill up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($ProductPrice)) {
            $conEmpmsgProductPrice = 'Fill up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($MobileNumber)) {
            $empmsgMobileNumber = 'Fill up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($userAddress)) {
            $empmsguserAddress= 'Fil up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($entryDate)) {
            $conEmpmsgentryDate = 'Fil up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
    ...
    if (!empty($ProductName)  && !empty($ProductCategory) && !empty($ProductCode) && !empty($ProductPrice) && !empty($Email)  && !empty($MobileNumber) && !empty($userAddress) && !empty($entryDate)) {
        ...
        $sql = "INSERT INTO headphone (ProductName,	ProductCategory,	ProductCode,	ProductPrice,	Email,	MobileNumber, userAddress,	entryDate)
                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="headPhone/cuteHPhn.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Cute Cat Wireless Head-Phones </h3>
                                            <p>Color     : Pink</p>
                                            <p>Price    : $250 <br>
                                            Product Code    : ccwhp33 <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="cuteWlsHPhn.php" method="post">
