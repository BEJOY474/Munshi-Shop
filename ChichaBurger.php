...
<?php 
 ...
 if ( isset($_POST['submit'])) {
    ...
    if (!empty($ProductName)  && !empty($ProductCategory) && !empty($ProductCode) && !empty($ProductPrice) && !empty($Email)  && !empty($MobileNumber) && !empty($userAddress) && !empty($entryDate)) {
        ...
        $sql = "INSERT INTO burger (ProductName,	ProductCategory,	ProductCode,	ProductPrice,	Email,	MobileNumber, userAddress,	entryDate)
                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="burgerPic/ChichaBurger.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Chicha Burger</h3> 
                                            <p>Price    : $20 <br>
                                            Product Code    : cb117 <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="ChichaBurger.php" method="post">
                                           ...
                                           <div class="form-floating mb-3">
                                            <label for="floatingInput">Burger Code</label>                 
                                           ...
                                           <div class="form-floating mb-3">
                                            <label for="floatingInput">Burger Price</label>                 
