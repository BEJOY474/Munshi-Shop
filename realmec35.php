                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="mobile/Realme-C35.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Realme-c35</h3>
                                            <p>Color     : White</p>
                                            <p>Price    : $600 <br>
                                               Ram       : 4 GB  <br>
                                            Procesor     : Snapdragon 888 Plus <br>
                                            Dimensions	: 160.6 x 73.9 x 8 mm (6.32 x 2.91 x 0.31 in) <br>
                                            Weight	 : 150 g (6.24 oz) <br>
                                            Build	 : Glass front, plastic frame, plastic back <br>
                                            SIM	Dual  :  SIM (Nano-SIM, dual stand-by) <br>
                                            Product Code    : realmec35sd34 <br>
                                            Discount    : 20%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="realmec35.php" method="post">
