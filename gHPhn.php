                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="headPhone/gameHPhone.jpg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Gaming Head-Phones </h3>
                                            <p>Color     : Black</p>
                                            <p>Price    : $950 <br>
                                            Product Code    : ghp4rt5 <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="gHPhn.php" method="post">
