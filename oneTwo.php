...
<div id="top">
  ...
  <source src="AllBackgroundMusic/oneTwo.mp3" type="audio/mp3">
</audio>
                       </li>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        ...
                        <div class="product">
                            <a onclick="aPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/one.png" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                            <div class="product">
                                    <a onclick="bPlay()">
                                        <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/tw.webp" alt="macbookLaptop">
                                    </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        ...
                        <div class="product">
                            <a onclick="cPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/three.png" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        <div class="product">
                            <a onclick="dPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/four.jpeg" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        <div class="product">
                            <a onclick="ePlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/five.png" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        <div class="product">
                            <a onclick="fPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/six.png" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        ...
                        <div class="product">
                            <a onclick="gPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/svn.jpeg" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        <div class="product">
                                <a onclick="hPlay()">
                                    <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/eight.jpeg" alt="macbookLaptop">
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        ...
                        <div class="product">
                            <a onclick="iPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/nine.jpeg" alt="macbookLaptop">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 center-responsive">
                        <div class="product">
                            <a onclick="jPlay()">
                                <img style="width: 350px; height: 265px" class="img-responsive" src="oneTwoPic/tn.png" alt="macbookLaptop">
                            </a>
