                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="food/pizza2.jpg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Cheese Pizza</h3> 
                                            <p>Price    : $10 <br>
                                            Product Code    : cp429 <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="Cheesepizza.php" method="post">
