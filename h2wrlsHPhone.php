                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="headPhone/headPhn.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : H2 Wireless Headp-hones </h3>
                                            <p>Color     : Pink</p>
                                            <p>Price    : $500 <br>
                                            Product Code    : h2whphne <br>
                                            Discount    : 10%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="h2wrlsHPhone.php" method="post">
