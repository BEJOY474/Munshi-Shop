...
<?php 
 ...
 if ( isset($_POST['submit'])) {
        ...
        if (empty($ProductCategory)) {
            $empmsgProductCategory= 'Fil up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($ProductCode)) {
            $empmsgProductCode = 'Fil up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($ProductPrice)) {
            $conEmpmsgProductPrice = 'Fil up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img src="images/newMacPro.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Macbook Pro 13</h3>
                                            <p>Color     : White</p>
                                            <p>Price    : $1500 <br>
                                               Ram       : 8 GB  <br>
                                               Processor     : Core i7 <br>
                                            Version     : 2021 <br>
                                            Product Code    : mbkPro13 <br>
                                            Discount    : 5%
