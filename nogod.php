...
if ( isset($_POST['submit'])) {
    ...
    if (!empty($email) && !empty($pass)) {
        ...
        if($phon ==  $email ){
            echo "<script>window.location.href='orderSeccess.php';</script>";
            ...
            $mail->Subject = "Munshi Shop Order";
            $mail->Body = "Congratulation!!! " ."$n_me ". "Your order is done। <br>" . "Total bill : " ."$totalSum" ." $" ."<br>Thank You" ;
...
<div class="box text-center" id="box" >  
<div style="text-align:center ;" class="row">
                        <form action="nogod.php" method="POST">
                        
                        <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Nogod Number" name="Emails" required> <br>
                        ...
                        <div class="form-floating mb-3">
                                    <input type="password" class="form-control" id="floatingPassword" placeholder="Pin Number" name="Passwordss" required>
