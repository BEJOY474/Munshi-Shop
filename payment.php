    ...
    <div class="container">
        ...
        <div class="col-md-9">
            ...
            <div class="col-sm-4 col-sm-6 single">
                <div class="product">
                    <a href="bksh.php">
                        <img style="width: 350px; height: 265px" class="img-responsive" src="food/BKash-bKash2-Logo.wine.svg" alt="macbookLaptop">
                    </a>
            ...
            <div class="col-sm-4 col-sm-6 single">
                <div class="product">
                    <a href="rocket.php">
                        <img style="width: 350px; height: 265px" class="img-responsive" src="food/rocket.png" alt="macbookLaptop">
                    </a>
            ...
            <div class="col-sm-4 col-sm-6 single">
                <div class="product">
                    <a href="nogod.php">
                        <img style="width: 350px; height: 265px" class="img-responsive" src="food/download.png" alt="macbookLaptop">
                    </a>
                </div>
            </div>
            </div>
