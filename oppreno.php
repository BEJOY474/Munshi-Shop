                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="mobile/Oppo-Reno8-China-Official-Image-300x300.webp" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Oppo-Reno</h3>
                                            <p>Color     : Silver</p>
                                            <p>Price    : $550 <br>
                                               Ram       : 4 GB  <br>
                                            Processor     : Kirin 985 <br>
                                            Dimensions	: 140.6 x 73.9 x 8 mm (6.32 x 2.91 x 0.31 in) <br>
                                            Weight	 : 177 g (6.24 oz) <br>
                                            Build	 : Glass front, plastic frame, plastic back <br>
                                            SIM	Dual  :  SIM (Nano-SIM, dual stand-by) <br>
                                            Product Code    : opporeno435 <br>
                                            Discount    : 20%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="oppreno.php" method="post">
