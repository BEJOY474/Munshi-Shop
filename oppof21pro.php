                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="mobile/oppof21Pro.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Oppo-F21-Pro</h3>
                                            <p>Color     : Orange</p>
                                            <p>Price    : $850 <br>
                                               Ram       : 4 GB  <br>
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="oppof21pro.php" method="post">
