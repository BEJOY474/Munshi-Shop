...
<?php 
 ...
 if ( isset($_POST['submit'])) {
        ...
        if (empty($userAddress)) {
            $empmsguserAddress= 'Fill up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
        ...
        if (empty($entryDate)) {
            $conEmpmsgentryDate = 'Fill up this field';
            echo   '<audio controls autoplay>
            <source src="music/empty.mp3" type="audio/mp3">
          </audio>';
        }
    ...
    if (!empty($ProductName)  && !empty($ProductCategory) && !empty($ProductCode) && !empty($ProductPrice) && !empty($Email)  && !empty($MobileNumber) && !empty($userAddress) && !empty($entryDate)) {
        ...
        $sql = "INSERT INTO kidsBook (ProductName,	ProductCategory,	ProductCode,	ProductPrice,	Email,	MobileNumber, userAddress,	entryDate)
                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="kidsPic/animal.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Animals</h3>
                                            <p>Price    : $7 <br> 
                                            Product Code    : Animals075 <br>
                                            Discount    : No
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="AnimalsOrdr.php" method="post">
