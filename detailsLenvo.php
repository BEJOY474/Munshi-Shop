                            ...
                            <div id="myCarousel" class="carousel slide">
                                   ...
                                   <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img style="width: 350px; height: 265px" src="images/lenovo_yoga_9.jpeg" alt=""></center>
                                        </div>
                                        <div class="details_1">
                                            <h3>Name    : Lenovo Yoga 9</h3>
                                            <p>Color     : White</p>
                                            <p>Price    : $1600 <br>
                                               Ram       : 16 GB  <br>
                                               Processor     : Core i7 <br>
                                            Version     : 11 Gen. <br>
                                            Product Code    : LenovoYoga9aj45 <br>
                                            Discount    : 5%
                        ...
                        <div id="mainImage">
                            <div id="myCarousel" class="carousel slide">       
                                   <div class="carousel-inner orderInput">                                      
                                        <form action="detailsLenvo.php" method="post">
