...
if(!$conn){
   ...
   $sql = "SELECT user_id, user_name,phone_number,user_email,user_password FROM userMshop WHERE phone_number=' $phon'";
   ...
   if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        $id = $row["user_id"];
       echo  " <h4> Name:  </h4>  " . $row["user_name"]. "<br>" ." <h4> Email:  </h4>  " 
       . $row["user_email"] ."<br>" . " <h4> Phone Number:  </h4>  ".'0'.
        $row["phone_number"]. "<br><span class='btn btn-success'><a href='edit.php?id=$id'>Update Profile</a></span>" ."<br>";
     }
   } else {
